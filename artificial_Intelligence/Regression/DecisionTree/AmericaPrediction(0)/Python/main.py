...
**Fertility rate ratio = (total fertility rate) / (white fertility rate)**
WARNING: Fertility Rate Ratios in unmarked years estimations are nearly based on average rate of change between marked years
"""
